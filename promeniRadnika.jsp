...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Izmenite Radnika</h1><br>
		...
		<div class="w3-card-4 w3-dark-grey" id="divuserslika">
    		<div class="w3-container w3-center">
     			 <img src="slike/noviradnikforma.png" style="width:100%">
    		</div>
  		</div>
    <div id="unosradnika">
    <%
    	Radnik r = new Radnik();
    	r = (Radnik) request.getAttribute("r");
    %>
    <form action="ServletAdmin" method="post">
    	<input type="hidden" name="radnik_id" value="<%=r.getRadnik_id() %>">
    	<input class="unosradnikaforma" type="text" name="ime_radnika" value="<%=r.getIme_radnika() %>" placeholder="Unesite Ime Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="prezime_radnika" value="<%=r.getPrezime_radnika() %>" placeholder="Unesite Prezime Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="adresa_radnika" value="<%= r.getAdresa_radnika() %>" placeholder="Unesite Adresu Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="broj_telefona_radnika" value="<%=r.getBroj_telefona_radnika() %>" placeholder="Unesite Broj Telefona Radnika"><br><br>
    	<input class="dugmeunosradnika" type="submit" title="Unos novog Radnika" name="akcija" value="Izmeni Radnika">
    </form>
