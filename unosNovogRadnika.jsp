...
<title>Unos Novog Radnika</title>
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Unesite novog Radnika</h1><br>
    ...
    <form action="ServletAdmin" method="post">
    	<input class="unosradnikaforma" type="text" name="ime_radnika" value="${param.ime_radnika }" placeholder="Unesite Ime Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="prezime_radnika" value="${param.prezime_radnika }" placeholder="Unesite Prezime Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="adresa_radnika" value="${param.adresa_radnika }" placeholder="Unesite Adresu Radnika"><br>
    	<input class="unosradnikaforma" type="text" name="broj_telefona_radnika" value="${param.broj_telefona_radnika }" placeholder="Unesite Broj Telefona Radnika"><br><br>
    	<input class="dugmeunosradnika" type="submit" title="Unos novog Radnika" name="akcija" value="Unesi Radnika">
    </form>
