...
<title>Unos Novog Nacina Isporuke</title>
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Izmenite način Isporuke</h1><br>
    ...
    <div class="w3-card-4 w3-dark-grey" id="divuserslika">
    		<div class="w3-container w3-center">
     			 <img src="slike/unosisporukeforma.png" style="width:100%">
    		</div>
  		</div>
     <div id="unosisporuke">
     <%
    	NacinIsporuke ni = new NacinIsporuke();
    	ni = (NacinIsporuke) request.getAttribute("ni");
    %>
    <form action="ServletAdmin" method="post">
    	<input type="hidden" name="nacin_isporuke_id" value="<%= ni.getNacin_isporuke_id()%>">
    	<input class="unosisporuke" type="text" name="naziv_isporuke" value="<%=ni.getNaziv_isporuke() %>" placeholder="Unesite Naziv Isporuke"><br>
    	
    	<input class="dugmeunosisporuke" type="submit" name="akcija" value="Izmeni Nacin Isporuke">
    </form>
