...
<title>Svi Nacini Isporuke</title>
...
.tabelaisporuketh:first-child {
  border-top-left-radius:3px;
}
 
.tabelaisporuketh:last-child {
...
.tabelaisporuketr:hover td {
  background:#4E5066;
  color:#FFFFFF;
  border-top: 1px solid #22262e;
  border-bottom: 1px solid #22262e;
}
.tabelaisporuketr:first-child {
  border-top:none;
}

.tabelaisporuketr:last-child {
  border-bottom:none;
}
 
.tabelaisporuketr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.tabelaisporuketr:nth-child(odd):hover td {
  background:#4E5066;
}

.tabelaisporuketr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.tabelaisporuketr:last-child td:last-child {
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih Načina Isporuke</h1><br>
		...
		<button title="Prikaz Računa" class="dugmeracuni"><a class="linkracuni" href="ServletAdmin?akcija=racuni">Računi</a></button>
		<button title="Prikaz Dobavljača" class="dugmedobavljaci"><a class="linkdobavljaci" href="ServletAdmin?akcija=dobavljaci">Dobavljači</a></button>
		<br>
		
	<table id="tabelaisporuke">
		<tr class="tabelaisporuketr">
			<th class="tabelaisporuketh">ID Načina Isporuke</th>
			<th class="tabelaisporuketh">Naziv Načina Isporuke</th>
			<th class="tabelaisporuketh" align="center" colspan="2">AKCIJA</th>
		</tr>
		<%
			ArrayList<NacinIsporuke> loI = (ArrayList<NacinIsporuke>) sesija.getAttribute("loI");
			if(loI != null){
			for(NacinIsporuke pom : loI){
		%>
		<tr class="tabelaisporuketr">
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getNacin_isporuke_id() %></td>
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getNaziv_isporuke() %></td>
			<td class="tabelaisporuketd" style="padding:5px;;text-align: center;" align="center"><button class="dugmeobrisi" title="Brisanje načina isporuke"><a class="obrisiisporuku" href="ServletAdmin?akcija=ObrisiIsporuku&nacin_isporuke_id=<%= pom.getNacin_isporuke_id()%>">Obriši</a></button></td>
			<td class="tabelaisporuketd" style="padding:5px;;text-align: center;" align="center"><button class="dugmeobrisi" title="Promeni način isporuke"><a class="obrisiisporuku" href="ServletAdmin?akcija=UrediIsporuku&nacin_isporuke_id=<%= pom.getNacin_isporuke_id()%>">Izmeni</a></button></td>
		
		</tr>
		<%} }%>
	</table>
		
		<a title="Unesite Nov Način Isporuke" href="unosNoveIsporuke.jsp"><img class="isporukaslika" title="Unesite Nov Način Isporuke" src="slike/novaisporuka.png"><hr class="putic"></a>
