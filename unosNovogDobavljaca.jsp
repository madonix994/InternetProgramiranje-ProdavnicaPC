...
<title>Unos Novog Dobavljaca</title>
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Unesite novog Dobavljača</h1><br>
    ...
    <form action="ServletAdmin" method="post">
    	<input class="unosdobavljaca" type="text" name="naziv_dobavljaca" value="${param.naziv_dobavljaca }" placeholder="Unesite Naziv Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="adresa_dobavljaca" value="${param.adresa_dobavljaca }" placeholder="Unesite Adresu Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="broj_telefona_dobavljaca" value="${param.broj_telefona_dobavljaca }" placeholder="Unesite Broj Telefona Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="grad" value="${param.grad }" placeholder="Unesite Grad Dobavljača"><br>
    	<br>
    	<input class="dugmeunosdobavljaca" type="submit" name="akcija" value="Unesi Dobavljaca">
    </form>
