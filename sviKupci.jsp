...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih Registrovanih Klijenata</h1><br>
		...
		<button title="Prikaz Računa" class="dugmedobavljaci"><a class="linkdobavljaci" href="ServletAdmin?akcija=dobavljaci">Dobavljaci</a></button>
	...
	<table id="tabelaisporuke">
		<tr class="tabelaisporuketr">
			<th class="tabelaisporuketh">ID Kupca</th>
			<th class="tabelaisporuketh">Ime</th>
			<th class="tabelaisporuketh">Prezime</th>
			<th class="tabelaisporuketh">Adresa</th>
			<th class="tabelaisporuketh">Username</th>
		</tr>
		<%
			ArrayList<Kupac> loKU = (ArrayList<Kupac>) sesija.getAttribute("loKU");
			if(loKU != null){
			for(Kupac pom : loKU){
		%>
		<tr class="tabelaisporuketr">
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getKupac_id() %></td>
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getIme_kupca() %></td>
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getPrezime_kupca() %></td>
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getAdresa_kupca() %></td>
			<td class="tabelaisporuketd" style="text-align: center;"><%=pom.getUsername_kupca() %></td>
		</tr>
		<%} }%>
	</table>    
