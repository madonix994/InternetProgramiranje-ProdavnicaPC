...
<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Izmenite Kategoriju</h1><br>
    ...
    <%
    	...
    	ta = (TipArtikla) request.getAttribute("ta");
    %>
    <form action="ServletAdmin" method="post">
    	<input type="hidden" name="tip_artikla_id" value="<%=ta.getTip_artikla_id()%>">
    	<input class="unoskategorije" type="text" name="ime_tipa_artikla" value="<%=ta.getIme_tipa_artikla() %>" placeholder="Unesite Naziv Kategorije"><br>
    	<input class="unoskategorije" type="text" name="opis_tipa_artikla" value="<%=ta.getOpis_tipa_artikla() %>" placeholder="Unesite kratak opis"><br>
    	<br>
    	<input class="dugmeunoskategorije" type="submit" name="akcija" value="Izmeni Kategoriju">
    </form>
