...
.tabeladobavljacith:first-child {
  border-top-left-radius:3px;
}
 
.tabeladobavljacith:last-child {
...
.tabeladobavljacitr:hover td {
  background:#4E5066;
  color:#FFFFFF;
  border-top: 1px solid #22262e;
  border-bottom: 1px solid #22262e;
}
.tabeladobavljacitr:first-child {
  border-top:none;
}

.tabeladobavljacitr:last-child {
  border-bottom:none;
}
 
.tabeladobavljacitr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.tabeladobavljacitr:nth-child(odd):hover td {
  background:#4E5066;
}

.tabeladobavljacitr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.tabeladobavljacitr:last-child td:last-child {
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih Dobavljača</h1><br>
		...
		<button title="Prikaz Isporuka" class="dugmeisporuke"><a class="linkisporuke" href="ServletAdmin?akcija=isporuka">Isporuke</a></button>
		<button title="Prikaz Kupaca" class="dugmekupci"><a class="linkkupci" href="ServletAdmin?akcija=kupci">Kupci</a></button>
		<br>
		
	<table id="tabeladobavljaci">
		<tr class="tabeladobavljacitr">
			<th class="tabeladobavljacith">ID Dobavljača</th>
			<th class="tabeladobavljacith">Naziv Dobavljača</th>
			<th class="tabeladobavljacith">Adresa Dobavljača</th>
			<th class="tabeladobavljacith">Broj Telefona Dobavljača</th>
			<th class="tabeladobavljacith">Grad Dobavljača</th>
			<th class="tabeladobavljacith" align="center" colspan="2">AKCIJA</th>
		</tr>
		<%
			ArrayList<Dobavljac> loD = (ArrayList<Dobavljac>) sesija.getAttribute("loD");
			if(loD != null){
			for(Dobavljac pom : loD){
		%>
		<tr class="tabeladobavljacitr">
			<td class="tabeladobavljacitd" style="text-align: center;"><%=pom.getDobavljac_id() %></td>
			<td class="tabeladobavljacitd" style="text-align: center;"><%=pom.getNaziv_dobavljaca() %></td>
			<td class="tabeladobavljacitd" style="text-align: center;"><%=pom.getAdresa_dobavljaca() %></td>
			<td class="tabeladobavljacitd" style="text-align: center;"><%=pom.getBroj_telefona_dobavljaca() %></td>
			<td class="tabeladobavljacitd" style="text-align: center;"><%=pom.getGrad() %></td>
			<td class="tabeladobavljacitd" style="text-align: center;" align="center"><button class="dugmeobrisi" title="Brisanje Dobavljača <%=pom.getNaziv_dobavljaca() %>"><a class="obrisidobavljaca"  href="ServletAdmin?akcija=ObrisiDobavljaca&dobavljac_id=<%= pom.getDobavljac_id()%>">Obriši</a></button></td>
			<td class="tabeladobavljacitd" style="text-align: center;" align="center"><button class="dugmeobrisi" title="Uredi Dobavljača <%=pom.getNaziv_dobavljaca() %>"><a class="obrisidobavljaca"  href="ServletAdmin?akcija=UrediDobavljaca&dobavljac_id=<%= pom.getDobavljac_id()%>">Izmeni</a></button></td>
		</tr>
		<%} }%>
	</table>
		
		
		<a title="Unesite Novog Dobavljača" href="unosNovogDobavljaca.jsp"><img title="Unesite Novog Dobavljača" class="novidobavljac" src="slike/novidobavljac.png"></a>
		<p class="novidobavljactext">Unesite Novog Dobavljača</p>
    </div>
