...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Unesite nov način Isporuke</h1><br>
    ...
    <form action="ServletAdmin" method="post">
    	<input class="unosisporuke" type="text" name="naziv_isporuke" value="${param.naziv_isporuke }" placeholder="Unesite Naziv Isporuke"><br>
    	
    	<input class="dugmeunosisporuke" type="submit" name="akcija" value="Unesi Nacin Isporuke">
    </form>
