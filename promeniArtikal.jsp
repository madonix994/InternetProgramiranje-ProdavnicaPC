...
<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Izmenite Artikal</h1><br>
    ...
    <div class="w3-card-4 w3-dark-grey" id="divuserslika">
    		<div class="w3-container w3-center">
     			 <img src="slike/artikliforma.png" style="width:100%">
    		</div>
  		</div>
    <div id="unoskategorije">
    <%
    	Artikal ar = new Artikal();
    	ar = (Artikal) request.getAttribute("a");
    		
    %>
    <form action="ServletAdmin" method="post">
       	<input type="hidden" name="artikal_id" value="<%=ar.getArtikal_id()%>">
    	<input class="unoskategorije" type="text" name="naziv_artikla" value="<%=ar.getNaziv_artikla() %>" placeholder="Unesite Naziv Artikla"><br>
    	<input class="unoskategorije" type="text" name="prodajna_cena_artikla" value="<%=ar.getProdajna_cena_artikla() %>" placeholder="Unesite Prodajnu Cenu Artikla"><br>
    	<input class="unoskategorije" type="text" name="kolicina_artikla" value="<%=ar.getKolicina_artikla() %>" placeholder="Unesite Kolicinu Artikla"><br>
    	<br>
    	<input type="hidden" name="tip_artikla_id_ta" value="<%= ar.getTip_artikla_id_ta()%>">
    	<input class="dugmeunosartikla" type="submit" name="akcija" title="Izmenite Artikal" value="Izmeni Artikal">
   </form>
