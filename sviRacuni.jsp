...
.tabelaracunith:first-child {
  border-top-left-radius:3px;
}
 
.tabelaracunith:last-child {
...
.tabelaracunitr:hover td {
  background:#4E5066;
  color:#FFFFFF;
  border-top: 1px solid #22262e;
  border-bottom: 1px solid #22262e;
}
.tabelaracunitr:first-child {
  border-top:none;
}

.tabelaracunitr:last-child {
  border-bottom:none;
}
 
.tabelaracunitr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.tabelaracunitr:nth-child(odd):hover td {
  background:#4E5066;
}

.tabelaracunitr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.tabelaracunitr:last-child td:last-child {
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih računa</h1><br>
		...
		<br>
			...
			<button title="Prikaz Artikla" class="dugmeartikli"><a class="linkartikli" href="ServletAdmin?akcija=artikli">Artikli</a></button>
			<button title="Prikaz Načina Isporuke" class="dugmeisporuka"><a class="linkisporuka" href="ServletAdmin?akcija=isporuka">Isporuke</a></button>
		<br>
		
		
		
	<table id="tabelaracuni">
		<tr class="tabelaracunitr">
			<th class="tabelaracunith">Broj Računa</th>
			<th class="tabelaracunith" colspan="2">Kupac</th>
			<th class="tabelaracunith" colspan="2">Radnik</th>	
			<th class="tabelaracunith">Adresa Kupca</th>					
			<th class="tabelaracunith">Način Isporuke</th>
			<th class="tabelaracunith">Iznos Računa</th>
			<th class="tabelaracunith">Status</th>
			<th class="tabelaracunith">Datum Izdavanja</th>
			<th class="tabelaracunith">Pregled</th>
		</tr>
		<%
			
			ArrayList<SviRacuni> loR = (ArrayList<SviRacuni>) sesija.getAttribute("loR");
			if(loR != null){
			for(SviRacuni pom : loR){
		%>
		<tr class="tabelaracunitr">
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getRacun_id() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getIme_kupca() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getPrezime_kupca() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getIme_radnika() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getPrezime_radnika() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getAdresa_kupca() %></td>	
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getNaziv_isporuke() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getUkupna_cena() %></td>	
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getStatus()%></td>
			<td class="tabelaracunitd" style="text-align: center;"><%=pom.getDatum_izdavanja() %></td>
			<td class="tabelaracunitd" style="text-align: center;"><a title="Detalji o računu" href="ServletRacun?akcija=detaljiadmin&racun_id=<%=pom.getRacun_id() %>" class="myButton2">Detalji</a></td>
