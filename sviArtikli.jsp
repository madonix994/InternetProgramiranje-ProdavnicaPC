...
.tabelartiklith:first-child {
  border-top-left-radius:3px;
}
 
.tabelartiklith:last-child {
...
.tabelartiklitr:hover td {
  background:#4E5066;
  color:#FFFFFF;
  border-top: 1px solid #22262e;
  border-bottom: 1px solid #22262e;
}
.tabelartiklitr:first-child {
  border-top:none;
}

.tabelartiklitr:last-child {
  border-bottom:none;
}
 
.tabelartiklitr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.tabelartiklitr:nth-child(odd):hover td {
  background:#4E5066;
}

.tabelartiklitr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.tabelartiklitr:last-child td:last-child {
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih Artikala</h1><br>
		...
		<button title="Unos novog Artikla" class="dugmeunosartikla"><a class="linkunosartikla" href="unosNovogArtikla.jsp">Unos novog Artikla</a></button>
	...
	<table id="tabelartikli">
		<tr class="tabelartiklitr">
			<th class="tabelartiklith">RB Artikla</th>
			<th class="tabelartiklith">Naziv Artikla</th>
			<th class="tabelartiklith">Tip Artikla</th>
			<th class="tabelartiklith">Trenutno na Stanju</th>
			<th class="tabelartiklith">Cena Po Komadu</th>
			<th class="tabelartiklith" colspan="2">AKCIJA</th>
		</tr>
		<%
			ArrayList<Tip_artiklaArtikal> loAR = (ArrayList<Tip_artiklaArtikal>) sesija.getAttribute("loAR");
			if(loAR != null){
				int i=1;
			for(Tip_artiklaArtikal pom : loAR){
				
		%>
		<tr class="tabelartiklitr">
			<td class="tabelartiklitd" style="text-align: center;"><%=i++ %></td>
			<td class="tabelartiklitd" style="text-align: center;"><%=pom.getNaziv_artikla() %></td>
			<td class="tabelartiklitd" style="text-align: center;"><%=pom.getIme_tipa_artikla() %></td>
			<td class="tabelartiklitd" style="text-align: center;"><%=pom.getKolicina_artikla() %></td>
			<td class="tabelartiklitd" style="text-align: center;"><%=pom.getProdajna_cena_artikla() %></td>
			<td class="tabelartiklitd" style="text-align: center;" align="center"><button title="Uredi Artikal <%=pom.getNaziv_artikla() %>" class="dugmeobrisi"><a class="obrisiartikal" href="ServletAdmin?akcija=UrediArtikal&artikal_id=<%= pom.getArtikal_id()%>">Uredi</a></button></td>
		</tr>
		<%} }%>
	</table>
