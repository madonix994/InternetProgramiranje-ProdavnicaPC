...
<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Unesite novi Artikal</h1><br>
    ...
    <form action="ServletAdmin" method="post">
    	<input class="unoskategorije" type="text" name="naziv_artikla" value="${param.naziv_artikla }" placeholder="Unesite Naziv Artikla"><br>
    	<input class="unoskategorije" type="text" name="prodajna_cena_artikla" value="${param.prodajna_cena_artikla }" placeholder="Unesite Prodajnu Cenu Artikla"><br>
    	<input class="unoskategorije" type="text" name="kolicina_artikla" value="${param.kolicina_artikla }" placeholder="Unesite Kolicinu Artikla"><br>
		<p style="margin-top: 5px;margin-bottom: 5px;">Odaberite Tip Artikla:</p>
		<select name="tip_artikla_id_ta">
			<option>IZABERITE</option>
			<option value="1">Desktop Računari</option>
			<option value="2">Laptop Uređaji</option>
			<option value="3">Monitori</option>
			<option value="4">Tableti</option>
		</select>
    	<br>
    	<input class="dugmeunosartikla" type="submit" name="akcija" title="Unesite Artikal" value="Unesi Artikal">
    </form>
