...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Izmenite Dobavljača</h1><br>
    ...
    <div class="w3-card-4 w3-dark-grey" id="divuserslika">
    		<div class="w3-container w3-center">
     			 <img src="slike/unosisdobavljacaforma.png" style="width:100%">
    		</div>
  		</div>
    
     <div id="unosdobavljaca">
     <%
    	Dobavljac dob = new Dobavljac();
    	dob = (Dobavljac) request.getAttribute("dob");
    %>
    <form action="ServletAdmin" method="post">
    	<input type="hidden" name="dobavljac_id" value="<%= dob.getDobavljac_id()%>">
    	<input class="unosdobavljaca" type="text" name="naziv_dobavljaca" value="<%=dob.getNaziv_dobavljaca() %>" placeholder="Unesite Naziv Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="adresa_dobavljaca" value="<%=dob.getAdresa_dobavljaca() %>" placeholder="Unesite Adresu Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="broj_telefona_dobavljaca" value="<%=dob.getBroj_telefona_dobavljaca() %>" placeholder="Unesite Broj Telefona Dobavljača"><br>
    	<input class="unosdobavljaca" type="text" name="grad" value="<%=dob.getGrad() %>" placeholder="Unesite Grad Dobavljača"><br>
    	<br>
    	<input class="dugmeunosdobavljaca" type="submit" name="akcija" value="Izmeni Dobavljaca">
    </form>
    <%String msgU = (String) request.getAttribute("msgU"); 
    	if(msgU != null && msgU.trim().length() > 0){%>
    	<h3><%=msgU %></h3>
    <%}%>
  	</div>
    </div>
