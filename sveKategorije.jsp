...
.tabelakategorijeth:first-child {
  border-top-left-radius:3px;
}
 
.tabelakategorijeth:last-child {
...
.tabelakategorijetr:hover td {
  background:#4E5066;
  color:#FFFFFF;
  border-top: 1px solid #22262e;
  border-bottom: 1px solid #22262e;
}
.tabelakategorijetr:first-child {
  border-top:none;
}

.tabelakategorijetr:last-child {
  border-bottom:none;
}
 
.tabelakategorijetr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.tabelakategorijetr:nth-child(odd):hover td {
  background:#4E5066;
}

.tabelakategorijetr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.tabelakategorijetr:last-child td:last-child {
...
<br><br>
	...
	<div class="prvidiv">
    	...
    	<h1 class="prvinaslov">Prikaz svih Kategorija</h1><br>
		<br>
		...
		<br>
	<table id="tabelakategorije">
		<tr class="tabelakategorijetr">
			<th class="tabelakategorijeth">Broj Kategorije</th>
			<th class="tabelakategorijeth">Ime Kategorije</th>
			<th class="tabelakategorijeth">Opis Kategorije</th>
			<th class="tabelakategorijeth" align="center" colspan="2">AKCIJA</th>
		</tr>
		<%
			ArrayList<TipArtikla> loK = (ArrayList<TipArtikla>) sesija.getAttribute("loK");
			if(loK != null){
			for(TipArtikla pom : loK){
		%>
		<tr class="tabelakategorijetr">
			<td class="tabelakategorijetd" style="text-align: center;"><%=pom.getTip_artikla_id() %></td>
			<td class="tabelakategorijetd" style="text-align: center;"><%=pom.getIme_tipa_artikla() %></td>
			<td class="tabelakategorijetd" style="text-align: center;"><%=pom.getOpis_tipa_artikla() %></td>
			<td class="tabelakategorijetd" style="text-align: center;" align="center"><button title="Brisanje kategorije <%=pom.getIme_tipa_artikla() %>" class="dugmeobrisi"><a class="obrisikategoriju" href="ServletAdmin?akcija=ObrisiKategoriju&tip_artikla_id=<%= pom.getTip_artikla_id()%>">Obriši</a></button></td>
			<td class="tabelakategorijetd" style="text-align: center;" align="center"><button title="Uredi kategoriju <%=pom.getIme_tipa_artikla() %>" class="dugmeobrisi"><a class="obrisikategoriju" href="ServletAdmin?akcija=UrediKategoriju&tip_artikla_id=<%= pom.getTip_artikla_id()%>">Uredi</a></button></td>
		</tr>
		<%} }%>
	</table>
		
		<a title="Unesite novu Kategoriju" href="unosNoveKategorije.jsp"><img class="novakategorijaslika" title="Unesite novu Kategoriju" src="slike/novakategorija2.png"></a>
    	<p class="novakategorijatext">Unesite novu Kategoriju</p>
