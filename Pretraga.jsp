...
.lista2tr:nth-child(odd) td {
  background:#EBEBEB;
}
 
.lista2tr:nth-child(odd):hover td {
  background:#4E5066;
}

.lista2tr:last-child td:first-child {
  border-bottom-left-radius:3px;
}
 
.lista2tr:last-child td:last-child {
...
<%ArrayList<Tip_artiklaArtikal> lista2 =(ArrayList<Tip_artiklaArtikal>)sesija.getAttribute("nazivi"); 
if(lista2!=null && lista2.size()>0){
%>
		
		<h1 style="margin-top: 270px;" class="prvinaslov">Rezultat pretrage</h1>
		<table align="center" id="lista2">
		<caption></caption>
		<tr class="lista2tr" style="text-align: center;">
		<th class="lista2th">Tip</th>
		<th class="lista2th">Naziv</th>
		<th class="lista2th">Cena</th>
		<th class="lista2th">Akcija</th>
		</tr>
		<%for(Tip_artiklaArtikal pom:lista2){ %>
		
		<tr class="lista2tr">
		<td class="lista2td"><%=pom.getIme_tipa_artikla() %></td>
		<td class="lista2td"><%=pom.getNaziv_artikla() %></td>
		<td class="lista2td"><%=pom.getProdajna_cena_artikla() %> din.</td>
		<td style="text-align: center;" class="lista2td"><button title="Kupite <%=pom.getNaziv_artikla() %>" class="dugmekupi"><a class="akcijakupi" href="ServletKategorije?akcija=KupiPretraga&artikal_id=<%=pom.getArtikal_id()%>">Kupi</a></button></td>
		</tr>
		...
		<%}else{ %>
<h2 class="prvinaslov">Pronadjite potreban proizvod</h2>
		<form action="ServletKategorije" method="post" >
<input id="pretraga1" type="text" name="naziv_artikla" placeholder="Pretraži..">
<input id="pretragadugme1" type="submit" name="akcija" value="Pretrazi">
</form>
<%} %>
